...
if [[ $4 = $5 ]] && [[ $5 = "pinhole-radtan" ]]; then
    python3 $1/scripts/undistortion_radtan.py $1/data/pictures/img_0.png $1/data/pictures/img_1.png $1/$first_part-camchain.yaml
elif [[ $4 == $5 ]] && [[ $5 = "pinhole-equi" ]]; then
    python3 $1/scripts/undistortion_equi.py $1/data/pictures/img_0.png $1/data/pictures/img_1.png $1/data/$first_part-camchain.yaml
else 
